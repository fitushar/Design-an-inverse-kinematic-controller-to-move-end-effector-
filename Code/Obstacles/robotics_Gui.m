...
% Last Modified by GUIDE v2.5 02-Jul-2018 16:43:44
...
a=str2num(handles.edit7.String);
b=str2num(handles.edit8.String);
cd=str2num(handles.edit9.String);

obstacle_center = [a, b, cd]';
